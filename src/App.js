      ...
      <section className='create-schedule'>
        <div className='create-schedule__container-1'>
          ...
          <div className='export'>
              ...
              <input type="radio" id="domestic" name="export" value="domestic"/> 
          ...
          <div className='coil-dimensions'>
              <section className='thickness'>
                <h3>Thickness</h3>
                <label for="thick-from">From</label>
                <input type="text" id="thick-from" name="thickness from"/> <br/>
                
                <label for="thick-to">To</label>
                <input type="text" id="thick-to" name="thickness to"/>
                
              </section>
              <section className='width'>
                <h3>Width</h3>
                <label for="width-from">From</label>
                <input type="text" id="width-from" name="width from"/> <br/>
                
                <label for="width-to">To</label>
                <input type="text" id="width-to" name="width to"/>            
              </section>
          </div>
